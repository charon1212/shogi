...
describe('KifFile.readKifFile', () => {
  ...
  it('test2', () => {
    ...
    assertShogiMove(createShogiMove('g33>34'), node2!.value.move);
    assertShogiMove(createShogiMove('s27>26'), node3!.value.move);
    assertShogiMove(createShogiMove('g83>84'), node4!.value.move);
    assertShogiMove(createShogiMove('s26>25'), node5!.value.move);
    assertShogiMove(createShogiMove('g84>85'), node6!.value.move);
    assertShogiMove(createShogiMove('s69>78'), node7!.value.move);
    assertShogiMove(createShogiMove('g41>32'), node8!.value.move);
    assertShogiMove(createShogiMove('s25>24'), node9!.value.move);
    assertShogiMove(createShogiMove('g23>24'), node10!.value.move);
    assertShogiMove(createShogiMove('s28>24'), node11!.value.move);
    assertShogiMove(createShogiMove('g85>86'), node12!.value.move);
    assertShogiMove(createShogiMove('s87>86'), node13!.value.move);
    assertShogiMove(createShogiMove('g82>86'), node14!.value.move);
    assertShogiMove(createShogiMove('s24>34'), node15!.value.move);
    ...
    assertShogiMove(createShogiMove('g22>33'), node16_1!.value.move);
    assertShogiMove(createShogiMove('s34>36'), node17_1!.value.move);
    assertShogiMove(createShogiMove('g86>84'), node18_1!.value.move);
    assertShogiMove(createShogiMove('s36>26'), node19_1!.value.move);
    assertShogiMove(createShogiMove('g31>22'), node20_1!.value.move);
    assertShogiMove(createShogiMove('s  >87p'), node21_1!.value.move);
    ...
    assertShogiMove(createShogiMove('g22>88!'), node16_2!.value.move);
    assertShogiMove(createShogiMove('s79>88'), node17_2!.value.move);
    assertShogiMove(createShogiMove('g  >28p'), node18_2!.value.move);
    assertShogiMove(createShogiMove('s39>28'), node19_2!.value.move);
    assertShogiMove(createShogiMove('g  >45b'), node20_2!.value.move);
    assertShogiMove(createShogiMove('s34>24'), node21_2!.value.move);
    assertShogiMove(createShogiMove('g  >23p'), node22_2!.value.move);
    assertShogiMove(createShogiMove('s  >77b'), node23_2!.value.move);
    assertShogiMove(createShogiMove('g86>88!'), node24_2!.value.move);
    assertShogiMove(createShogiMove('s77>88'), node25_2!.value.move);
    assertShogiMove(createShogiMove('g23>24'), node26_2!.value.move);
    assertShogiMove(createShogiMove('s88>11!'), node27_2!.value.move);
    assertShogiMove(createShogiMove('g21>33'), node28_2!.value.move);
    ...
    assertShogiMove(createShogiMove('s  >77b'), node21_3!.value.move);
    assertShogiMove(createShogiMove('g86>88!'), node22_3!.value.move);
    assertShogiMove(createShogiMove('s77>88'), node23_3!.value.move);
    assertShogiMove(createShogiMove('g45>34'), node24_3!.value.move);
    assertShogiMove(createShogiMove('s88>11!'), node25_3!.value.move);
    assertShogiMove(createShogiMove('g21>33'), node26_3!.value.move);
